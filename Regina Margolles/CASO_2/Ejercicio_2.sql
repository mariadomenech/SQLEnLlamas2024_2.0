...
--Select * from CTE_runner_orders_clean;
--Select * from CTE_customer_orders_clean;
---Select * from CTE_runner_orders_clean;

Select  table1.runner_id,
        table1.orders,
		table1.number_pizzas_without_cancellation,
		CASE WHEN table1.total_orders= 0 THEN 0
		     ELSE ROUND(table1.orders*100/cast(table1.total_orders as decimal(5,2)),2,1)  
			 END as percent_runner,
		CASE WHEN table1.number_pizzas_without_cancellation = 0 THEN 0
