...
BEGIN
	...
	ELSE
		PRINT 'EL CLIENTE ' + CAST(@customer_id AS VARCHAR(10)) + ' SE HA GASTADO UN TOTAL DE ' +
				CAST(@total_spend AS VARCHAR(23)) + ' EUR EN COMPRAS DE PRODUCTOS EN EL MES DE ' +
...
EXECUTE case02.PNG_Ejercicio3_1_Procedimiento1 @customer_id = @check_customer_id, @year = @check_year, @month_name = @check_month_name;
GO
-- Eliminación el procedimiento almacenado
DROP PROCEDURE case02.PNG_Ejercicio3_1_Procedimiento1;
