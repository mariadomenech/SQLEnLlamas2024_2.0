/* Reto4 , Crear un procedimiento almacenado que al introducir el identificador de cliente y el mes, calcule el total de compras y devuelva el mensaje
           "El cliente x , ha gastado un total de xxx eur en compras de productos en el mes de marzo"*/

create procedure JLMG_Ejercicio3_4_TotalMovimientoCliente @tipo_calculo int,@cliente int,@mes int,@anio int   
as
/*
@tipo_calculo
